...
export default function LoginPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden p-4 font-['Poppins'] text-[#0B1F33] lg:p-6"
        style={{
        ...
        <div className="flex min-h-full flex-col px-5 py-6 sm:px-8 lg:px-12 lg:py-10">
          ...
          <div className="flex items-center gap-3">
           <div className="flex h-11 w-11 items-center justify-center overflow-hidden rounded-2xl bg-[#F8F9FE]">
            ...
            <div>
              <h1 className="text-lg font-bold leading-none text-[#0B1F33]">
                Kiyutz
              </h1>
          ...
          <div className="flex flex-1 items-center justify-center py-10">
            <div className="w-full max-w-[420px]">
              <div className="text-center">
                ...
                <h2 className="text-3xl font-bold leading-tight text-[#0B1F33] md:text-4xl">
                  Welcome Back
                </h2>
              ...
              <form className="mt-8 space-y-5">
                ...
                <div>
                  ...
                  <div className="flex h-12 items-center gap-3 rounded-xl border border-[#F2F2F2] bg-white px-4 transition focus-within:border-[#0B1F33] focus-within:ring-4 focus-within:ring-[#0B1F33]/5">
                    <Mail size={18} className="text-[#6C7095]" />

                    <input
                      type="email"
                      placeholder="admin@kiyutz.com"
                      defaultValue="admin@kiyutz.com"
                      className="h-full w-full bg-transparent text-sm font-medium text-[#0B1F33] outline-none placeholder:text-[#6C7095]"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex h-12 items-center gap-3 rounded-xl border border-[#F2F2F2] bg-white px-4 transition focus-within:border-[#0B1F33] focus-within:ring-4 focus-within:ring-[#0B1F33]/5">
                    <Lock size={18} className="text-[#6C7095]" />

                    <input
                      type={showPassword ? "text" : "password"}
                      placeholder="Masukkan password"
                      defaultValue="kiyutzadmin"
                      className="h-full w-full bg-transparent text-sm font-medium text-[#0B1F33] outline-none placeholder:text-[#6C7095]"
                    />
                ...
                <button
                  type="button"
                  className="group inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#0B1F33] px-5 text-sm font-semibold text-white shadow-[0_14px_28px_rgba(11,31,51,0.18)] transition hover:-translate-y-0.5 hover:opacity-95"
                >
                  Log In
                  <ArrowRight
                    size={18}
          ...
          <div className="flex flex-col gap-3 text-xs text-[#6C7095] sm:flex-row sm:items-center sm:justify-between">
            ...
            <a href="#" className="transition hover:text-[#0B1F33]">
              Privacy Policy
            </a>
          </div>
        </div>
          ...
          <div className="relative z-10 flex h-full flex-col justify-center">
            <div className="max-w-[560px]">
              ...
              <p className="mt-5 max-w-[460px] text-sm leading-relaxed text-white/70">
                Kelola data product, category, status product, dan insight
                dashboard dalam satu tampilan yang clean dan mudah digunakan.
              </p>
            </div>
            ...
            <div className="mt-10 w-full max-w-[620px] rounded-[24px] border border-white/15 bg-white/12 p-4 shadow-[0_30px_80px_rgba(0,0,0,0.25)] backdrop-blur">
              <div className="rounded-[20px] bg-white p-5">
                <div className="mb-5 flex items-center justify-between">
                  <div>
                    <p className="text-xs font-semibold text-[#B268A7]">
                      Dashboard Preview
                    </p>
                  ...
                  <div className="rounded-full bg-[#F8F9FE] px-3 py-1 text-xs font-semibold text-[#6C7095]">
                    Weekly
                  </div>
                </div>
...
function PreviewCard({ icon: Icon, label, value, tone }: PreviewCardProps) {
  const toneClass = {
  ...
  return (
    <div className="rounded-2xl border border-[#F2F2F2] bg-[#F8F9FE] p-4">
      <div
        className={`mb-4 flex h-9 w-9 items-center justify-center rounded-xl ${toneClass[tone]}`}
      >
        <Icon size={18} />
      </div>
